...
u1 = User.create!(username: "Johnny Bravo", email: "johnny@gmail.com", password: "password")
u5 = User.create!(username: "Tanya Top", email: "tanya@gmail.com", password: "password")
u4 = User.create!(username: "Peter Piper", email: "peter@gmail.com", password: "password")
u3 = User.create!(username: "Lily Luvgud", email: "lily@gmail.com", password: "password")
u2 = User.create!(username: "Sally Sells", email: "jim@gmail.com", password: "password")
...
p1 = Playlist.create!(name: "Shelter In Place Loudly", user_id: u1.id)
p1 = Playlist.create!(name: "Quaranjam", user_id: u2.id)
p1 = Playlist.create!(name: "Roadtrip Mix", user_id: u3.id)
p1 = Playlist.create!(name: "Spaghetti Code Jams", user_id: u4.id)
p1 = Playlist.create!(name: "Runner's Club", user_id: u5.id)
p1 = Playlist.create!(name: "Retro Rewind", user_id: u1.id)
p1 = Playlist.create!(name: "Millenium Jams", user_id: u1.id)
